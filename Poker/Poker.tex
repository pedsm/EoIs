...
Our team has a huge interest in this project for a series of reasons. Not only would we be eager to work on such a project but we also have experience on very similar projects which would allow us to have a kickstart on the work. Pedro and Jonny in particular have participated in two hackathons in the last year where they made multiplayer games, using Node.js servers.\\
On their last hackathon they created a multiscreen multiplayer game which implemented many concepts that could also be applied to this project. One of these hackathons was HackUPC - one of the largest hackathons in Europe - and they both made it to the finalist teams. 
